...
public class PanelListaCompra extends JPanel implements ChangeListener {
	...
	private void initializeEvents() {
		...
		this.btnPagar.addActionListener(listenerBotonPagar(this.controladorPanelListaCompra));
	}
	...
	private ActionListener listenerBotonPagar(ControladorPanelListaCompra controladorPanelListaCompra) {
		return new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (rdbtnTicket.isSelected() && !textPane_NºTransaccion.getText().equals("") && !textPane_Fecha.getText().equals("") && !textPane_Local.getText().equals("") && !textPane_Total.getText().equals("")) {
					...
					controladorPanelListaCompra.accionadoBottonPagarPanelListaCompra();
